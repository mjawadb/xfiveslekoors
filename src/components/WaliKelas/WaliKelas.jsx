        ...
        <>
            ...
            <section className={`bg-primary relative ${styles.paddingX} ${styles.paddingY}`}>
                <div className={`flex flex-col ${styles.flexCenter}`}>
                    <h1 className={`font-poppins font-bold text-secondary sm:text-4xl text-3xl pb-10 relative z-[1]`} id='anggota-kelas' data-aos="fade-left">And Our Daddy Dadang</h1>
